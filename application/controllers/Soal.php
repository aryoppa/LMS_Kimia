...
class Soal extends CI_Controller
{
	...
	public function insert()
	{
		...
		$data = array(
			...
			'image_a' => $image_a, // Save the uploaded image_a file name
			'image_b' => $image_b, // Save the uploaded image_b file name
			'image_c' => $image_c, // Save the uploaded image_c file name
			'image_d' => $image_d, // Save the uploaded image_d file name
			'image_e' => $image_e  // Save the uploaded image_e file name
		);
