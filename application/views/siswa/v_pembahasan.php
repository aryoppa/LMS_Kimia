                                ...
                                <div style="display: flex; align-items: start; gap: 62px;">
                                    <div>
										<p style="font-weight: 600;">
											<?= $j->jawaban; ?>.
                                            <?php $image_kunci = 'image_' . strtolower($j->jawaban); ?>
                                            <?php if (!empty($j->$image_kunci)): ?>
                                                <div>
                                                    <img src="<?= base_url('uploads/' . $j->$image_kunci); ?>" alt="Image" width="300">
                                                </div>
                                            <?php endif; ?>
										</p>
                                    </div>
                                ...
                                <div style="display: flex; align-items: start; gap: 62px">
                                    <div>
										<p style="font-weight: 600;">
                                            ...
                                            <?php 
                                            $image_kunci = 'image_' . strtolower($j->kunci_jawaban); 
                                            if (!empty($j->$image_kunci)): ?>
                                                <div>
                                                    <img src="<?= base_url('uploads/' . $j->$image_kunci); ?>" alt="Image" width="300">
                                                </div>
                                            <?php endif; ?>
